            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Restaurant:</td>
                            
                            <td valign="top" class="value"><g:link controller="restaurant" action="show" id="${reviewInstance?.restaurant?.id}">${reviewInstance?.restaurant?.encodeAsHTML()}</g:link></td>
